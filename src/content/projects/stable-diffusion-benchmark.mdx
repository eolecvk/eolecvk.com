...
tagline: "Benchmarking Stable Diffusion on different GPU configurations"
...
thumbnail: /images/projects/sd-bench-1.webp
date: 2023-09-03T10:31:47.439Z
featured: true
category: Image/Video
metric: Cited Google Research (Muse, 2023)
stats:
  - label: Citation
...
> **⚠️ Note:** This article is about the original Stable Diffusion model ([CompVis/stable-diffusion](https://github.com/CompVis/stable-diffusion)) which is no longer state-of-the-art.

**Stack:** Python, PyTorch, CUDA, diffusers | [GitHub](https://github.com/LambdaLabsML/lambda-diffusers/tree/eole/benchmarking)
...
<br />
<p align="center">
  <img src="/images/projects/sd-bench-2.webp" alt="Stable Diffusion Benchmark" />
</p>
<br />
...
<br />
<p align="center">
  <img src="/images/projects/sd-bench-3.webp" alt="Stable Diffusion Benchmark" />
</p>
<br />
...
<br />
<p align="center">
  <img src="/images/projects/sd-bench-4.webp" alt="Stable Diffusion Benchmark" />
</p>
<br />
...
<br />
<p align="center">
  <img src="/images/projects/sd-bench-5.webp" alt="Stable Diffusion Benchmark" />
</p>
<br />
...
<br />
<p align="center">
  <img src="/images/projects/sd-bench-6.webp" alt="Stable Diffusion Benchmark" />
</p>
<br />
...
<br />
<p align="center">
  <img src="/images/projects/sd-bench-10.webp" alt="Stable Diffusion Benchmark" />
</p>
<br />
