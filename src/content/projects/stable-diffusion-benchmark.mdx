...
tag:
  - stable-diffusion
title: All You Need is One GPU
tagline: "Inference Benchmark for Stable Diffusion (cited by Google Research)"
...
intro: "Inference Benchmark for Stable Diffusion (cited by Google Research)"
features:
  - name: Author
    value: Eole Cervenka
  - name: Published
...
style:
  ...
  container: md
  block_class: my-0
thumbnail: /images/projects/stable-diffusion-benchmark.png
...
<div style="border: 2px solid #d97706; border-radius: 6px; padding: 16px; margin-bottom: 24px; background-color: #fef3c7;">
  <strong style="color: #92400e;">⚠️ Note:</strong> <span style="color: #78350f;">This article is about the original Stable Diffusion model (<a href="https://github.com/CompVis/stable-diffusion" style="color: #b45309; text-decoration: underline;">CompVis/stable-diffusion</a>) which is no longer state-of-the-art.</span>
</div>

What do I need for running the Stable Diffusion text-to-image model? Can a gaming card do the job, or should I get a fancy A100? What if I only have a CPU?

<br />
<p align="center">
  <img src="/images/projects/sd-bench-1.png" alt="Stable Diffusion Benchmark" style="width: 85%;" />
</p>
<br />
...
<br />
<p align="center">
  <img src="/images/projects/sd-bench-2.png" alt="Stable Diffusion Benchmark" />
</p>
<br />
...
<br />
<p align="center">
  <img src="/images/projects/sd-bench-3.png" alt="Stable Diffusion Benchmark" />
</p>
<br />
...
<br />
<p align="center">
  <img src="/images/projects/sd-bench-4.png" alt="Stable Diffusion Benchmark" />
</p>
<br />
...
<br />
<p align="center">
  <img src="/images/projects/sd-bench-5.png" alt="Stable Diffusion Benchmark" />
</p>
<br />
...
<br />
<p align="center">
  <img src="/images/projects/sd-bench-6.png" alt="Stable Diffusion Benchmark" />
</p>
<br />
...
<br />
<p align="center">
  <img src="/images/projects/sd-bench-7.jpeg" alt="Stable Diffusion Benchmark" />
</p>
<br />

<br />
<p align="center">
  <img src="/images/projects/sd-bench-8.jpeg" alt="Stable Diffusion Benchmark" />
</p>
<br />
...
<br />
<p align="center">
  <img src="/images/projects/sd-bench-9.gif" alt="Stable Diffusion Benchmark" />
</p>
<br />
...
<br />
<p align="center">
  <img src="/images/projects/sd-bench-10.png" alt="Stable Diffusion Benchmark" />
</p>
<br />
