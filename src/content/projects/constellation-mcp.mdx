...
tag:
  ...
  - LLM
  - fintech
title: "Building an MCP Server for Financial Data"
tagline: "SQL-over-MCP for credit analysis — what works, what breaks, and why LLMs fabricate financial metrics"
