...
tagline: "Dreambooth pipeline for custom-style image generation"
...
![Bill Gates basic prompt](https://staticassetbucket.s3.us-west-1.amazonaws.com/bill_gates_vanilla.png)

![Bill Gates with prompt engineering](https://staticassetbucket.s3.us-west-1.amazonaws.com/bill_gates_ninja.png)
