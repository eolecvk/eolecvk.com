      ...
      <div>
        <div className="flex justify-between items-start mb-12">
          ...
          <a
            href="/resume.pdf"
            download
            className="px-6 py-3 bg-accent text-dark font-semibold rounded hover:opacity-90 active:scale-[0.98] transition-all duration-200 flex items-center gap-2 whitespace-nowrap focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:outline-none"
          >
